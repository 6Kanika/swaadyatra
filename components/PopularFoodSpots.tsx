...
const completedCities: Record<string, string> = {
  ...
  Kashmir: "/city/kashmir",
  Mumbai: "/city/mumbai",
  Pune: "/city/pune",
  Kolkata: "/city/kolkata",
  Nainital: "/city/nainital",
  Puri: "/city/puri",
  Darjeeling: "/city/darjeeling",
  Matheran: "/city/matheran",
  Mahabaleshwar: "/city/mahabaleshwar",
...
const foodSpots = [
  ...
  { name: "Kashmiri Wazwan",       city: "Kashmir",   shop: "JJ Foods",             image: cl("kash_jj_1_plsquv") },
  ...
  { name: "Mumbai Pav Bhaji",      city: "Mumbai",    shop: "Amar Pav Bhaji",       image: cl("mum_amar_1_ptbfin") },
  { name: "Lucknow Tunday Kabab",  city: "Lucknow",   shop: "Tunday Kababi",        image: cl("amrit_gurdas_1_bb11ui") },
  { name: "Nainital Momos",        city: "Nainital",  shop: "Tamang",               image: cl("nan_tamang_1_amqmoq") },
  { name: "Puri Odia Thali",       city: "Puri",        shop: "Dalma Restaurant",      image: cl("puri_dalma_1_dkh8my") },
  { name: "Darjeeling Momos",      city: "Darjeeling",  shop: "Gang Jong Restaurant",  image: cl("Darjeeling_Gangjong1_yxu7w9") },
  { name: "Pune Misal Pav",        city: "Pune",      shop: "Darpan Misal",         image: cl("Pune_darpan1_edcfuc") },
  { name: "Delhi Chole Bhature",   city: "Delhi",     shop: "SitaRam Diwan Chand",  image: cl("delhi_sitaram_1_gpvt99") },
  { name: "Kolkata Kathi Roll",    city: "Kolkata",   shop: "Nizam's Restaurant",   image: cl("kol_tiwari_1_ar17dv") },
  { name: "Jaipur Dal Baati Churma", city: "Jaipur",  shop: "Natraj Restaurant",    image: cl("JAI_natraj_1_jiwlts") },
  { name: "Matheran Misal Pav",         city: "Matheran",      shop: "Hotel Divadkar",           image: cl("math_divadkar_1_kdhs2d") },
  { name: "Mahabaleshwar Strawberries",  city: "Mahabaleshwar", shop: "Mapro Garden Food Court",  image: cl("maha_mapro_1_fa25i4") },
  { name: "Lucknow Basket Chaat",         city: "Lucknow",       shop: "Royal Cafe",              image: cl("luc_royal_2_fjcfbq") },
  { name: "Tirupati Andhra Thali",         city: "Tirupati",      shop: "PS4 Pure Veg Restaurant", image: cl("tir_ps4_1_wwxkd0") },
];
